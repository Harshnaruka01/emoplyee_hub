...
export const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <button
        onClick={() => navigate('/')}
        className="absolute top-4 left-4 sm:top-6 sm:left-6 flex items-center gap-2 text-xs font-semibold text-slate-400 hover:text-white transition-colors duration-150 py-2 px-3 rounded-lg hover:bg-slate-900/60 z-20"
      >
        <ChevronLeft className="h-4 w-4" /> Back to Search
      </button>

      {/* Login Box */}
      <div className="w-full max-w-md glass-panel rounded-3xl overflow-hidden shadow-2xl relative border-slate-800 animate-scale-up mt-16 sm:mt-0">
        {/* Accent strip */}
